...
TEST(SequenceTest, ImmutableArrayBehavior) {
...
TEST(SequenceTest, ImmutableListBehavior) {
    ...
    Sequence<int>* concat = seq->Concat(seq);
    EXPECT_EQ(concat->GetLength(), 6);
    EXPECT_EQ(concat->Get(0), 1);
    EXPECT_EQ(concat->Get(3), 1);
    delete concat;

    Sequence<int>* removed = seq->RemoveAt(1);
    EXPECT_EQ(removed->GetLength(), 2);
    EXPECT_EQ(removed->Get(0), 1);
    EXPECT_EQ(removed->Get(1), 3);
    delete removed;
